...
public class MealLineBO 
{
    ...
    /**
     * Adds a new MealLine to the list of referenced alternatives.
    ...
    /**
     * Removes the given MealLine from the list of referenced alternatives.
     * The cache will updated
     ...
     * @return the ParameterDefinitionUnit currently referenced in this MealLine. 
     */
