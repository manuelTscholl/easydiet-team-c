    ...
    create table FamilyAnamnesis_illnesses (
    ...
    create table ParameterDefinition (
        ...
        CheckPattern varchar(255) not null,
    ...
    alter table FamilyAnamnesis_illnesses 
        
        add constraint FKC15E8098F40A20CB 
    ...
    alter table ParameterDefinition 
        ...
        add constraint FK2803CDBC513EB178 
        foreign key (Type) 
    ...
    alter table Patient_illnesses 
        
        add constraint FK4552B554A7608723 
        foreign key (PatientId) 
        references Patient (PatientId);

    alter table RecipeIngedient 
        
        add constraint FKB34B7155776E333C 
        foreign key (IngredientId) 
        references Recipe (RecipeId);

    alter table RecipeIngedient 
        
        add constraint FKB34B715576981BB9 
        foreign key (RecipeId) 
        references Recipe (RecipeId);
