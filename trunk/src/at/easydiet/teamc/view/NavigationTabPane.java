...
public class NavigationTabPane extends TabPane implements Bindable {
	...
	public static final org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger
			.getLogger(NavigationTabPane.class);
	// instance variables
	...
	public void initialize(Map<String, Object> map, URL url, Resources rsrcs) {
		...
		_searchResultScrollPane = (ScrollPane) map
				.get("searchResultScrollPane");
		_searchActivityIndicator = (ActivityIndicator) map
		...
		getComponentListeners().add(new ComponentListenerAdapter() {
			...
			public void sizeChanged(Component component, int previousWidth,
					int previousHeight) {
				_searchResultScrollPane.setPreferredHeight(component
						.getHeight() - 35);
			}
		});
	}
	...
	/**
	 * Gets the edits table pane.
	 * 
	 * @return the edits table pane
	 */
	...
	/**
	 * Gets the navigation box pane.
	 * 
	 * @return the navigation box pane
	 */
	...
	/**
	 * Gets the patient data box pane.
	 * 
	 * @return the patient data box pane
	 */
	...
	public void updateSearchResult(Set<PatientData> patients) {
		...
		// draw search results
		SearchResult searchResult = SearchResult.getInstance(this,
				_searchResultTablePane);
	...
	/**
	 * Set dietry plan mode. Change content of each tab to provide usefull
	 * informations for the dietry plan
	 */
