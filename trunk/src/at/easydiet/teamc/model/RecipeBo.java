		...
		for (RecipeIngredientBo recipeIngredient : getRecipeIngredientsBo()) {// all
			...
			for (NutrimentParameter parameter : recipeIngredient
					.getRecipeIngredient().getRecipe().getNutrimentParameters()) {// for
																					...
																					// the
																					// ingredient
				long currParameterdefid = parameter.getParameterDefinition()
				...
				if (summedIngredientParameter.containsKey(currParameterdefid)) {// if
					...
					try {// converting the type and then sum it
						...
						sumValue = DietParameterUnitController
								.getInstance()
								.convert(
										source,
										target,
										Float.parseFloat(parameter.getValue())
												* (recipeIngredient
														.getIngredientAmount() / recipeIngredient
														.getRecipe()
														.getTotalAmount()));
					...
					summedIngredientParameter.put(parameter
							.getParameterDefinition()
							.getParameterDefinitionId(), validSum);
					idParameterMapping.put(parameter.getParameterDefinition()
							.getParameterDefinitionId(),
