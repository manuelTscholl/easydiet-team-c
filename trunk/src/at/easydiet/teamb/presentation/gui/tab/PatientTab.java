 ...
 * @author TeamB
 */
public class PatientTab extends AbstractLazyTab implements Bindable, EventListener<ValidatorArgs<PatientDataErrorField>> {
    private static final Logger LOGGER = Logger.getLogger(PatientTab.class);

    /**
     * @see at.easydiet.teamb.application.util.EventListener#fired(java.lang.Object, at.easydiet.teamb.application.util.EventArgs)
     */
    @Override
    ...
    /**
     * @see at.easydiet.teamb.presentation.gui.tab.AbstractTab#getHandler()
     */
    @Override
    ...
    /**
     * @see at.easydiet.teamb.presentation.gui.tab.AbstractTab#create()
     */
    @Override
    ...
    /**
     * @see at.easydiet.teamb.presentation.gui.tab.AbstractTab#save()
     */
    @Override
    ...
    /**
     * @see at.easydiet.teamb.presentation.gui.tab.AbstractTab#discard()
     */
    @Override
...
//
//        try {
//            _useCaseManager.changePatient(useCasePatientHandler.getPatientDataHandler().getPatient());
...
//                @Override
//                public void redo() throws OperationNotPermittedException {
//                    getLazyTab().create();
//                }
//            });
...
//
//        try {
//            _useCaseManager.changePatient(_useCasePatientHandler.getPatientDataHandler().getPatient());
//        } catch (PatientChangeNotPermittedException ex) {
...
//
//        if (_useCasePatientHandler == null) {
//            _useCasePatientHandler = new UseCasePatientHandler(_useCaseManager.getSelectedPatient());
//        }
//
//        _useCasePatientHandler.getPatientDataHandler().addValidadedListener(this);
//        _useCasePatientHandler.getPatientDataHandler().addDuplicatePatientListener((_duplicatePatientListener = new DuplicatePatientListener()));
//
//        updatePatient();
//
...
//            _useCasePatientHandler.getPatientDataHandler().removeDuplciatePatientListener(_duplicatePatientListener);
...
//                    newErrors.put(patientDataErrorField, _lastErrors.get(patientDataErrorField));
...
//    }
//
//    private class DuplicatePatientListener implements EventListener<DuplicatPatientEventArg> {
//        private Message _message;
//        
//        public DuplicatePatientListener() {
//            _message = new Message(MessageType.Info, "Es gibt bereits einen Patienten, der diesem gleicht.");
//        }
//        
//        @Override
