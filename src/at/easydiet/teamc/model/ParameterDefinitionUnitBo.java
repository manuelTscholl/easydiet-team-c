...
public class ParameterDefinitionUnitBo  implements java.io.Serializable, Saveable, ParameterDefinitionUnitData
{
     ...
     */
    public ParameterDefinitionUnitBo(String name, ParameterDefinitionDataTypeBo type)
    {
       this(new ParameterDefinitionUnit(name, type.getParameterDefinitionDataType()));
       _type = type;
    }
    ...
    {
        this.getParameterDefinitionUnit().setParameterDefinitionUnitId(parameterDefinitionUnitId);
    }
    ...
    {
        this.getParameterDefinitionUnit().setType(type.getParameterDefinitionDataType());
        this._type = type;
    }
