...
public class PatientBo 
{
    ...
    public GenderBo getGender()
    {
        if(_gender == null)
        {
            _gender = new GenderBo(_model.getGender());
        }
        return _gender;
    }
    ...
    {
        _gender = gender;
        _model.setGender(gender.getGender());
    }
	
    private FamilyStatusBo _familyStatus;
    
    /**
     * Gets the currently referenced FamilyStatus of this instance.
     * @return the FamilyStatus currently referenced in this Patient. 
     */
    public FamilyStatusBo getFamilyStatus()
    {
        if(_familyStatus == null)
        {
            _familyStatus = new FamilyStatusBo(_model.getFamilyStatus());
        }
        return _familyStatus;
    }
    
    /**
     * Sets the FamilyStatus to be referenced in this instance
     * @param familyStatus the FamilyStatus to reference in this Patient. 
     */
    public void setFamilyStatus(FamilyStatusBo familyStatus)
    {
        _familyStatus = familyStatus;
        _model.setFamilyStatus(familyStatus.getModel());
    }
     ...
     * This list is cached, use {@link Patient#updateIllnessesCache()) to update this cache.
