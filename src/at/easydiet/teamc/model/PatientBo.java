...
public class PatientBo implements java.io.Serializable, Saveable, PatientData
{
    ...
    {
        return this.getPatient().getPassword();
    }

    public String getUsername()
    {
        return this.getPatient().getUsername();
    }
    
    public void setPassword(String password)
    {
        this.getPatient().setPassword(password);
    }
    
    public void setUsername(String username)
    {
        this.getPatient().setUsername(username);
    }
    ...
    {
        // Set<RecipeBo> temp = new
        // HashSet<RecipeBo>(this._Patient.getDisfavors()
        // .size());
    ...
    public boolean save()
    {
        ...
        if (DAOFactory.getInstance().getPatientDAO()
                .makePersistent(this._Patient) != null) return true;
        return false;
    }

    /**
     * Returns all DietPlans of a Patient
     * @return List<DietPlanBo>
     */
     public List<DietPlanBo> getAllDietPlans(){
        List<DietPlanBo> temp = new ArrayList<DietPlanBo>();
        for(DietTreatmentBo dtb: this.getTreatments()){
      ...
      */
    public DietTreatmentBo searchDietTreatmentBo(Date startDate, Date endDate)
            throws NoDietTreatmentException
    {
        Date tempenddate;
        if (getTreatments().size() > 0)
        {
            for (DietTreatmentBo dietTreatmentBo : this.getTreatments())
            {
                ...
                if (dietTreatmentBo.getStart().getTime() <= startDate.getTime()
