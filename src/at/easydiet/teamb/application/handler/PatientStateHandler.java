 ...
 */
public class PatientStateHandler extends
		AbstractHandler<PatientStateErrorField> {
	/** The _state. */
	 ...
	 */
	public PatientStateHandler(SystemUserViewable creator,
	...
	public double getBMI(double weight, double height) {
		return RoundUtil.round(BMIUtil.getBMI(height, weight), 2,
				RoundingMode.UP);
	}
	 ...
	 */
	public BMIEvaluationEnum getBMIEvaluation(GenderEnum gender,
			GregorianCalendar birthday, double bmi) {
	...
	public PatientStateTypeViewable[] getStateTypes() {
		return DAOFactory.getInstance().getPatientStateTypeDAO()
				.getAllPatientStateTypes();
	}
	...
	public void validatePatientState() {
		...
		_validaded.fireEvent(new ValidatorArgs<PatientStateErrorField>(
				_errorFields));
	}
