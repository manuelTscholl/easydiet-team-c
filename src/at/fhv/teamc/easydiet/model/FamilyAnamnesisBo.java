 ...
 */
public class FamilyAnamnesisBo  implements java.io.Serializable {
    ...
    public FamilyAnamnesisBo(FamilyAnamnesis familyAnamnesis, String person) {

        this(familyAnamnesis);
        this._FamilyAnamnesis.setPerson(person);
    }

    public FamilyAnamnesisBo(FamilyAnamnesis familyAnamnesis, String person, String[] illnesses) {
       this._FamilyAnamnesis.setPerson(person);
