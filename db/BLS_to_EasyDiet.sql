...
INSERT INTO fhv_easydiet.Recipe (Name, BlsCode, Difficulty, Description, Benefits, CookInstructions, Amount, ParameterDefinitionUnitId)
    SELECT a.name, a.blscode, 3, "", "", "", 100, (SELECT ParameterDefinitionUnitId FROM fhv_easydiet.ParameterDefinitionUnit WHERE Name='g') FROM fhv_bls.nahrungsmitteleintrag a;
...
UPDATE fhv_easydiet.NutrimentParameter a SET a.ParameterDefinitionUnitId = (
	SELECT c.ParameterDefinitionUnitId FROM fhv_easydiet.ParameterDefinitionUnit b 
		INNER JOIN fhv_easydiet.ParameterDefinitionUnit c ON c.Name = REPLACE(b.Name, '/100g', '') 
);	  